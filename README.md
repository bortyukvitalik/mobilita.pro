...
│
├── site/
│   ├── index.html             ← лендинг (один файл); согласие на ПДн — в попапе
│   ├── privacy.html           ← страница «Согласие на обработку ПДн» (тот же текст, что в попапе)
...
- **Полная Политика обработки ПДн** — сейчас текст согласия есть и в попапе, и на странице
  `/privacy.html` (реквизиты фонда, ОГРН). Развёрнутую политику от юриста можно добавить туда же;
